...
import { ViewController } from './js/ViewController.js'
import { ViewModel } from './js/ViewModel.js' 

let appViewModel = new ViewModel();
let appViewController = new ViewController(appViewModel);

document.addEventListener('DOMContentLoaded', appViewController.documentLoaded);